                    ...
                    <div {...provided.droppableProps} ref={provided.innerRef}>
                        {chapters.map((chapter, index) => (
                            ...
                            >
                                {(provided) => (
                                    <div
                                        className={`flex items-center gap-x-2  rounded-md mb-4 text-sm
                                            ${chapter.isPublished ?
                                            "bg-blue-100 border-blue-200 text-blue-700" : "bg-gray-200 border-gray-200 border text-gray-700"
                                            }
                                            dark:bg-slate-700 dark:border-slate-600 dark:text-slate-300
                                            dark:${chapter.isPublished &&
